...
*Code was debugged with the assistance of AI tools (Claude, Gemini); all research design, modeling choices, and interpretation of results are my own.*
...
**election_dummy10 -** Yearly binary indicator, 1 = U.S. general presidential election year, 0 Otherwise (1980–2024), 10-Year

**election_dummy1 -** Yearly binary indicator, 1 = U.S. general presidential election year, 0 Otherwise (1980–2024), 1-Year

**election_dummy3 -** Yearly binary indicator, 1 = U.S. general presidential election year, 0 Otherwise (1980–2024). 3-Month
...
Additionally, the GJR-GARCH forecasts for 10-year and 1-year annualized volatility echo the trend from both the regressions and the t-tests. Forecasts for 1-year annualize at a value just shy of 2% (0.019) and 10-year forecasts are extremely low, less than 1% (0.0092). This can be seen on the volatility plots as well, as the forecast for 1-year is on a slight upward trend (green line, screenshot 7.3 and slide 29) while the same forecast for 10-year treasuries look nearly flat (red line, screenshot 7.2 and slide 28). Additionally there are fewer large spikes on the 10-year plot compared to the 1-year, echoing the sentiment from above in a graphical way.
